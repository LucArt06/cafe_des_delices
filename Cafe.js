...
function cafeDelice() {
  ...
  // Création de l'évènement au moment du click
  ...
  function showProduit() {
    ...
    deleteButton.forEach(function (button, index) {
      // Création de l'évènement sur le bouton au moment du click
  ...
  // Création de la fonction qui permet de sauvegarder les données du tableau
  function save() {
